...
const CHARACTERS = {
  cagekeeper: {
    ...
    voicePrefix: 'VO_CK',
    portraits: {
      default: 'cagekeeper_default.webp',
      smile: 'cagekeeper_default.webp',
      surprised: 'cagekeeper_surprised.webp',
      serious: 'cagekeeper_serious.webp',
      think: 'cagekeeper_serious.webp',
      sad: 'cagekeeper_serious.webp'
    },
  ...
  yan: {
    ...
    voicePrefix: 'VO_R',
    portraits: {
      default: 'yan_default.webp',
      calm: 'yan_default.webp',
      serious: 'yan_serious.webp',
      think: 'yan_think.webp',
      surprised: 'yan_surprised.webp',
      cold: 'yan_cold.webp',
      smile: 'yan_smile.webp',
      angry: 'yan_cold.webp',
      lose: 'yan_default.webp'
    },
  ...
  ying: {
    ...
    voicePrefix: 'VO_YG',
    portraits: {
      default: 'ying_default.webp',
      smile: 'ying_smile.webp',
      surprised: 'ying_surprised.webp',
      think: 'ying_think.webp',
      sad: 'ying_sad.webp',
      energetic: 'ying_energetic.webp'
    },
  ...
  plotter: {
    ...
    voicePrefix: 'VO_P',
    portraits: {
      default: 'plotter_default.webp',
      smirk: 'plotter_smirk.webp',
      angry: 'plotter_angry.webp',
      surprised: 'plotter_surprised.webp',
      confident: 'plotter_confident.webp',
      shadow_default: 'plotter_shadow_default.webp',
      shadow_smirk: 'plotter_shadow_smirk.webp'
    },
    voice: 'zh-CN-YunyeNeural',
    voiceStyle: 'calm'
  },
  plotterShadow: {
    ...
    voicePrefix: 'VO_PS',
    portraits: {
      default: 'plotter_shadow_default.webp',
      smirk: 'plotter_shadow_smirk.webp',
      angry: 'plotter_shadow_default.webp',
      surprised: 'plotter_shadow_default.webp',
      confident: 'plotter_shadow_smirk.webp'
    },
    voice: 'zh-CN-YunyeNeural',
    voiceStyle: 'calm'
  },
  weaver: {
    ...
    voicePrefix: 'VO_W',
    portraits: {
      default: 'weaver_default.webp',
      surprised: 'weaver_default.webp',
      smirk: 'weaver_default.webp',
      angry: 'weaver_default.webp'
    },
  ...
  remnant: {
    ...
    voicePrefix: 'VO_RE',
    portraits: {
      default: 'remnant_default.webp',
      stern: 'remnant_default.webp',
      surprised: 'remnant_default.webp'
    },
    voice: 'zh-CN-YunxiNeural',
  ...
  setterSecret: {
    ...
    voicePrefix: 'VO_SS',
    portraits: {
      default: 'setter_secret_default.webp',
      smirk: 'setter_secret_smirk.webp',
      angry: 'setter_secret_angry.webp',
      surprised: 'setter_secret_surprised.webp',
      confident: 'setter_secret_confident.webp'
    },
    voice: 'zh-CN-YunyeNeural',
    voiceStyle: 'calm',
    rate: '-5%',
...
const DIALOGUES = {
  ...
  // ---- 阿妍 (10句) ----
  VO_R_01: { char: 'yan', portrait: 'default', text: '嘿！你就是新来的档案侦探？', scene: 'yan_boss_intro', effect: 3 },
  VO_R_02: { char: 'yan', portrait: 'default', text: '想进下一层？先过我这关！', scene: 'yan_boss_start', effect: 3 },
  VO_R_03: { char: 'yan', portrait: 'smile', text: '哈哈，这题可没那么简单哦！', scene: 'yan_stuck', effect: 0 },
  VO_R_04: { char: 'yan', portrait: 'surprised', text: '诶？！', scene: 'yan_break', effect: 1 },
  VO_R_05: { char: 'yan', portrait: 'surprised', text: '你居然能解开？！', scene: 'yan_break2', effect: 2 },
  VO_R_06: { char: 'yan', portrait: 'angry', text: '可恶！', scene: 'yan_tied', effect: 2 },
  VO_R_07: { char: 'yan', portrait: 'angry', text: '我还没认真呢！', scene: 'yan_tied', effect: 1 },
  VO_R_08: { char: 'yan', portrait: 'lose', text: '切……', scene: 'yan_defeat', effect: 2 },
  VO_R_09: { char: 'yan', portrait: 'lose', text: '算你厉害……', scene: 'yan_defeat', effect: 2 },
  VO_R_10: { char: 'yan', portrait: 'angry', text: '后面还有更难的！', scene: 'yan_after', effect: 0 },
  ...
  VO_SS_03: { char: 'setterSecret', portrait: 'confident', text: '数对、三子法、二连纵横阵、三才游鱼阵……我会全部用出来。', scene: 'ch7_final', effect: 4 },
  ...
  VO_SS_06: { char: 'setterSecret', portrait: 'smirk', text: '你以为看到了三才游鱼阵？不，那只是我的诱饵。', scene: 'setter_battle', effect: 2 },
  VO_SS_07: { char: 'setterSecret', portrait: 'surprised', text: '……不可能！', scene: 'setter_broken', effect: 3 },
  VO_SS_08: { char: 'setterSecret', portrait: 'angry', text: '二连纵横阵构型……被你看穿了？！', scene: 'setter_broken2', effect: 3 },
  ...
  // ---- 阿妍·终章 (3句) ----
  VO_R_11: { char: 'yan', portrait: 'surprised', text: '他……他的气场完全变了！比之前强太多了！', scene: 'ch7_final', effect: 2 },
  VO_R_12: { char: 'yan', portrait: 'smile', text: '我们赢了？！我们真的赢了设局人完全体？！', scene: 'setter_defeat', effect: 2 },
  VO_R_13: { char: 'yan', portrait: 'smile', text: '太好了！以后你就是大师了，我还当你的助手！', scene: 'true_ending', effect: 1 },
  ...
  CH1_N02: { char: 'narrator', portrait: null, text: '你推开尘封三十年的档案馆大门，空气中弥漫着旧纸张的气息。', scene: 'ch1_opening_full', effect: 0, sfx: 'playDoorOpen' },
  CH1_YAN01: { char: 'yan', portrait: 'smile', text: '哇，你就是新来的档案侦探？我叫阿岩，比你早来几天的实习侦探！', scene: 'ch1_opening_full', effect: 0, sfx: { name: 'playFootstep', args: [3], delay: 100 } },
  CH1_YAN02: { char: 'yan', portrait: 'smile', text: '别紧张，我会在旁边帮你翻译大师的话——他老人家说话总是文绉绉的！', scene: 'ch1_opening_full', effect: 0, sfx: 'playLaugh' },
  CH1_CK05: { char: 'cagekeeper', portrait: 'default', text: '从今天起，你们将从最基础的4×4盘面学起。记住三条铁律：每行、每列、每个2×2小宫格里，数字只能出现一次。', scene: 'ch1_opening_full', effect: 0, sfx: { name: 'playPaperFlip', delay: 200 } }
};
...
const SCENE_TRIGGERS = {
  ...
  ch1_opening_full: ['CH1_N01', 'CH1_N02', 'VO_CK_01', 'VO_CK_02', 'CH1_YAN01', 'VO_CK_03', 'VO_CK_04', 'CH1_YAN02', 'CH1_CK05'],
...
// ==========================================
// i18n 支持：将对话文本和角色名接入国际化系统
// 通过 getter 动态从 I18N 取翻译，fallback 到原始中文
// ==========================================
(function setupI18n() {
  // 从 i18n key 取翻译的工具函数
  function _getI18n(key, fallback) {
    try {
      if (typeof window.I18N !== 'undefined' && typeof window.I18N.getRaw === 'function') {
        const val = window.I18N.getRaw(key);
        if (val !== undefined && val !== null && val !== '') {
          return val;
        }
      }
    } catch (e) { /* 静默失败，fallback */ }
    return fallback;
  }

  // 给 DIALOGUES 每个条目加上 text/subtitle 的 getter
  // 注意：动态添加的条目（如 say() 创建的 _say_*）保持原样
  const _dialogueKeys = Object.keys(DIALOGUES);
  for (const key of _dialogueKeys) {
    const dlg = DIALOGUES[key];
    const i18nKey = 'story.dialogues.' + key.toLowerCase();
    const originalText = dlg.text;
    const originalSubtitle = dlg.subtitle;

    // text getter
    Object.defineProperty(dlg, 'text', {
      get: function() {
        // 动态创建的 _say_* 条目不走 i18n
        if (key.startsWith('_say_') || key.startsWith('_lines_')) {
          return this._rawText;
        }
        return _getI18n(i18nKey, originalText);
      },
      set: function(val) {
        this._rawText = val;
      },
    ...
    // subtitle getter（仅当原始有 subtitle 时）
    if (originalSubtitle !== undefined) {
      Object.defineProperty(dlg, 'subtitle', {
        get: function() {
          return _getI18n(i18nKey + '_subtitle', originalSubtitle);
        },
        configurable: true,
        enumerable: true
      });
  ...
  // 给 CHARACTERS 每个角色加上 name 的 getter
  const _charKeys = Object.keys(CHARACTERS);
  for (const key of _charKeys) {
    ...
    Object.defineProperty(char, 'name', {
      get: function() {
        return _getI18n('story.characters.' + key, originalName);
      },
      configurable: true,
      enumerable: true
    });
