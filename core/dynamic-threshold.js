 ...
 *  迁移自 cagemaster/hint/dynamic-threshold.js（2026-08-03）
 * ============================================================
 *
 ...
 *
 *  三个补丁：
 *  - 【补丁2】自动笔记屏蔽：开启Auto-Candidates时，L1-L3失效，回退到沉默时长+错漏频率
 ...
 * @property {boolean} autoCandidatesOn - 是否开启自动笔记
 */
...
class DynamicThresholdCalculator {
  ...
  static debugBreakdown(state) {
    ...
    if (state.autoCandidatesOn) {
      breakdown.adjustments.push({ reason: '自动笔记屏蔽', value: 0 });
      if (state.errorRate > this.HIGH_ERROR_THRESHOLD) {
