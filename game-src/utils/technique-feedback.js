...
(function(global) {
  ...
  const TechniqueFeedback = {
    ...
    _isRuleOf45(board, r, c, num, before) {
      ...
      if (remaining <= 1) return false;  // 1格就是裸单了，跳过
